...
was used to label the images so it can parse the columns correctly.
There are three ways to specify the template:
...
`read_image_data()` will detect it automatically and select the matching
bundled template:
